const translations = {
    ...
    openaiKeyHelp: "Create a key in OpenAI Platform → API keys.",
    openaiKeyLinkText: "Get OpenAI API key",
    geminiKeyHelp: "Create a key in Google AI Studio (free tier available).",
    geminiKeyLinkText: "Get Gemini API key",
    saveKeysButton: "Save keys",
    keysSaved: "API keys saved.",
    geminiStatusBuiltin: "On-device AI available (no key needed).",
    geminiStatusApiKey: "Using your Gemini API key.",
    geminiStatusNeedsSetup: "Needs a Gemini API key or Chrome Built-in AI.",
    postingComment: "Posting your comment...",
    previewingComment: "Previewing your comment...",
    generatingComment: "Generating your comment...",
    aiErrors: {
        MISSING_OPENAI_KEY: "Add your OpenAI API key in API Keys to use ChatGPT.",
        MISSING_GEMINI_KEY: "Add your Gemini API key, or enable Chrome Built-in AI.",
        GEMINI_NO_PROVIDER: "Gemini needs an API key or Chrome Built-in AI (Prompt API).",
        OPENAI_AUTH: "OpenAI rejected the API key. Check it and try again.",
        OPENAI_NETWORK: "Could not reach OpenAI. Check your connection or VPN.",
        OPENAI_API: "OpenAI request failed. Please try again.",
        OPENAI_QUOTA: "OpenAI quota/billing issue. Add payment method or credits at platform.openai.com/settings/organization/billing.",
        OPENAI_RATE_LIMIT: "OpenAI rate limit hit. Wait a moment and try again.",
        OPENAI_MODEL: "Your OpenAI key cannot use the requested model. Enable a chat model in your OpenAI project.",
        GEMINI_AUTH: "Gemini rejected the API key. Check it and try again.",
        GEMINI_NETWORK: "Could not reach Gemini. Check your connection.",
        GEMINI_API: "Gemini request failed. Please try again.",
        BUILTIN_UNAVAILABLE: "Chrome Built-in AI is not available on this device.",
        BUILTIN_FAILED: "On-device AI failed. Try again or add a Gemini API key.",
